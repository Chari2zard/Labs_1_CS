        ...
        public static void Main(string[] args)
        {
            ...
            do
            {
                ...
                switch (numberOfText)
                {
                    case 1:
                        isTrue = true;
                        path = @"C:\Users\lobod\Desktop\Лаба 1\гимн_rar(Base64).txt";
                        break;
                    case 2:
                        isTrue = true;
                        path = @"C:\Users\lobod\Desktop\Лаба 1\думи(Base64).txt";
                        break;
                    case 3:
                        path = @"C:\Users\lobod\Desktop\Лаба 1\пюре(Base64).txt";
                        isTrue = true;
                        break;
                    default:
                        isTrue = false;
